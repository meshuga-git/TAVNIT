...
int main(int argc, char *argv[]) {
    vector<string> prohibitive = read_restriction_folders("prohibitive_restrictions.txt");
    ...
    vector<string> aggregating = read_restriction_folders("aggregating_restrictions.txt");

    if (aggregating.size() == 1) {
        read_filenames_from_folder(aggregating[0] + "_parsed_files.txt", 2);
    }

    vector<string> random = read_restriction_folders("no_restrictions.txt");
